...
module Translatomatic
  module Translator
    ...
    class Microsoft < Base
      ...
      BASE_URL = "https://api.microsofttranslator.com/V2/Http.svc"
      TRANSLATE_URL = "#{BASE_URL}/TranslateArray"
      LANGUAGES_URL = "#{BASE_URL}/GetLanguagesForTranslate"
      ...
      def fetch_translations(strings, from, to)
        ...
        doc.search("//xmlns:TranslatedText").collect { |i| i.content }
      end
      ...
      def fetch_languages
        ...
        doc = Nokogiri::XML(response.body)
        doc.search("//xmlns:string").collect { |i| i.content }
      end
