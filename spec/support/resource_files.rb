...
RSpec.shared_examples 'a resource file' do |config = {}|
  ...
  it 'saves a file' do
    ...
    test_save(source_file, fixture_read("test_save.#{ext}"))
  end
  ...
  def test_save(source_file, expected_result)
    ext = described_class.extensions.first
    save_path = create_tempfile("test.#{ext}")
  ...
  def load_test_file(fixture = nil, options = {})
